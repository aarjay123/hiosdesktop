...
using HiOSDesktop.Contracts.ViewModels;

using Microsoft.Web.WebView2.Core;

namespace HiOSDesktop.ViewModels;
...
public partial class FeedbackViewModel : ObservableRecipient, INavigationAware
{
    // TODO: Set the default URL to display.
    [ObservableProperty]
    private Uri source = new("https://thehighlandcafe.github.io/hioswebcore/helpcenter/more/appfeedback.html");
    ...
    public FeedbackViewModel(IWebViewService webViewService)
    {
